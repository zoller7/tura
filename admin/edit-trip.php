...
// Get the ID fromt the link parameter
$tripId = $_GET['id'];
...
if (isset($_POST['save_trip'])) {
    ...
    // Set the SQL query
    $query = "UPDATE trips SET trip_active = '$trip_active', 
                               trip_name = '$trip_name',
                               trip_checkpoints = '$trip_checkpoints',
                               trip_pic = '$trip_pic', 
                               trip_shortdesc = '$trip_shortdesc',
                               trip_longdesc = '$trip_longdesc' WHERE trip_id = '$tripId' ";
        ...
        <form action="" method="POST">
            ...
            <div class="row mb-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="trip_id" id="trip_id" class="form-control" value="<?php print($trip["trip_id"]);?>" disabled />
                </div>
                </div>
                <div class="col">
                <div class="form-group">
                    ...
                    <select class="form-control" name="trip_active" id="trip_active">
                        <option value="1" <?php print ($trip["trip_active"] === '1') ? "selected" : ""; ?> id="trip_active-0">Aktív</option>
                        <option value="0" <?php print ($trip["trip_active"] === '0') ? "selected" : ""; ?> id="trip_active-0">Inaktív</option>
                    </select>
                </div>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="trip_name" id="trip_name" class="form-control" value="<?php print($trip["trip_name"]);?>" />
            </div>

            <!-- Number input -->
                <div class="form-group mb-4">
                <label class="form-label" for="trip_checkpoints">Túra checkpointok száma</label>
                <input type="number" name="trip_checkpoints" id="trip_checkpoints" min="1" max="10" step="1" class="form-control" value="<?php print($trip["trip_checkpoints"]);?>" />
            </div>

            <!-- Text input -->
            <div class="form-group mb-4">
                <label class="form-label" for="trip_pic">Túrakép URL</label>
                <input type="text" name="trip_pic" id="trip_pic" class="form-control" value="<?php print($trip["trip_pic"]);?>" />
            </div>

            <!-- Message input -->
            <div class="form-group mb-4">
            <label class="form-label" for="trip_shortdesc">Rövid leírás</label>
                <textarea class="form-control" name="trip_shortdesc" id="trip_shortdesc" rows="2"><?php print($trip["trip_shortdesc"]);?></textarea>
            </div>

            <!-- Message input -->
            <div class="form-group mb-4">
            <label class="form-label" for="trip_shortdesc">Hosszú leírás</label>
                <textarea class="form-control" name="trip_longdesc" id="trip_longdesc" rows="4"><?php print($trip["trip_longdesc"]);?></textarea>
            </div>
